...
@pytest.mark.asyncio
async def test_users_create_raises_on_integrity_error_instead_of_returning_unpersisted_user():
    db = _FakeSession()
...
@pytest.mark.asyncio
async def test_categories_create_raises_on_integrity_error_instead_of_returning_unpersisted_category():
    db = _FakeSession()
    user = _FakeUser()
